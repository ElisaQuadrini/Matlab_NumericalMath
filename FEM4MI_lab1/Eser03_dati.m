...
function [Dati]=Eser03_dati(test)  % file si deve chiamamre come la funzione che esso contiene
...
Dati = struct( 'name',             test,...
               ...
               'force',            '1-3*x.^2 ',...  
               ... % Forcing term
               'exact_sol',        '(1-x.^2).^2 ',... %quella dei dati dello scorso lab
               ... % Definition of exact solution
               'grad_exact',       '-4*x.*(1-x.^2)',...    
